...
function Invoke-BringToForeground {
    ...
    # Poll for the main window handle then force it front via Win32.
...
"@ -ErrorAction SilentlyContinue
        ...
        if ($hwnd -ne [IntPtr]::Zero) {
            [WW_Win32]::AllowSetForegroundWindow($Process.Id) | Out-Null
...
"@
        ...
        if ($showRetryButton) {
            ...
            $retryButton.Location = New-Object System.Drawing.Point(80, 250)
        ...
        if ($showRetryButton) {
            $exitButton.Location = New-Object System.Drawing.Point(270, 250)
        } else {
            $exitButton.Location = New-Object System.Drawing.Point(175, 250)  # Centered
        }
...
function Invoke-WalledGardenRemediation {
    ...
    try {
        ...
        $toastForm.Size = New-Object System.Drawing.Size(520, 280)
...
"@
        ...
        $lbl.Size = New-Object System.Drawing.Size(470, 180)
        $lbl.Text = $msg
        $lbl.Font = New-Object System.Drawing.Font("Segoe UI", 9)
        $toastForm.Controls.Add($lbl)

        $okBtn = New-Object System.Windows.Forms.Button
        $okBtn.Location = New-Object System.Drawing.Point(185, 205)
